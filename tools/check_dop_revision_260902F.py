#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902F DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    # Product-cycle and core-stage tooltip copy are author-managed in 260902F.
)
...
def check_version_and_scope() -> None:
    ...
    require("EARLY DEVELOPMENT BUILD 260902F" in version, "user-facing build is 260902F")
...
def main() -> int:
    ...
    check_content_flow()
    print("DOP 260902F REQUIREMENT ACCEPTANCE: PASS")
    return 0
