#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902C DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    # Product-cycle and core-stage tooltip copy are author-managed in 260902C.
)
...
def check_version_and_scope() -> None:
    ...
    require("EARLY DEVELOPMENT BUILD 260902C" in version, "user-facing build is 260902C")
    combined = "\n".join(
        text(relative)
        for relative in (
...
def main() -> int:
    ...
    print("DOP 260902C REQUIREMENT ACCEPTANCE: PASS")
    return 0
