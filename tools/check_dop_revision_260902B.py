#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902B DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    "DOP_GNG_restore_product_cycle_tt",
    "DOP_GNG_enter_core_stage_tt",
)
...
def check_version_and_scope() -> None:
    ...
    require("EARLY DEVELOPMENT BUILD 260902B" in version, "user-facing build is 260902B")
    combined = "\n".join(
        text(relative)
        for relative in (
...
def main() -> int:
    ...
    print("DOP 260902B REQUIREMENT ACCEPTANCE: PASS")
    return 0
