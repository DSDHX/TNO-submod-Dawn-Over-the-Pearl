...
DECISIONS.extend([
    E(0, 'commercial_attaches', '派遣科技武官开展商业技术情报收集',
      ...
      ('TNO_improve_research_facilities_low',), icon='GFX_decision_generic_investigate'),
    E(0, 'tariff_lobby', '游说欧美监管机构减免出口关税',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_document_concessions'),
    E(0, 'court_dissidents', '与各国科技界异见者暗通款曲',
      ...
      ('TNO_improve_academic_base_low',), icon='GFX_decision_generic_phone_call'),
    E(0, 'friendly_expositions', '赞助友好国家举办半导体展会',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_invitation'),
    E(0, 'shell_companies', '设立海外皮包公司与技术转运前哨',
      ...
      ('TNO_improve_admin_efficiency_med',), stage=1, icon='GFX_decision_generic_building_offices'),
    E(0, 'smuggle_blueprints', '越境走私关键图纸',
      ...
      ('TNO_improve_research_facilities_med',), stage=2, icon='GFX_decision_generic_document'),
    E(0, 'embargo_waivers', '积极参与技术禁运豁免谈判',
      ...
      ('TNO_improve_admin_efficiency_med',), stage=3, icon='GFX_decision_generic_handshake'),
...
DECISIONS.extend([
    E(4, 'recruit_assembly_labor', '招募低成本劳动力进入流水线',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_workers'),
    E(4, 'lower_piece_rates', '下调装配厂基础计件工资标准',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_decrease'),
    E(4, 'consumer_oem_orders', '承接民用电子产品代工',
      ...
      ('TNO_improve_industrial_equipment_low',), icon='GFX_decision_generic_consumer_goods'),
    E(4, 'bonding_consumables', '采购高速引线键合消耗材料',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_supply'),
    E(4, 'dip_expansion', '规模化扩建DIP双列直插封装产线',
      ...
      ('TNO_improve_industrial_equipment_med',), stage=1, icon='GFX_decision_generic_factory_blue'),
    ...
    E(4, 'smt_pilot_line', '引入表面贴装技术自动化试制线',
      ...
      ('TNO_improve_industrial_equipment_high',), stage=3, icon='GFX_decision_generic_electronics'),
    E(4, 'qfp_testing_center', '升级四方扁平封装高针脚产线与测试中心',
      ...
      icon='GFX_decision_generic_factory_inspection'),
])
...
DECISIONS.extend([
    E(5, 'liner_subsidies', '补贴电子产品专用班轮航线',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_shipyard'),
    ...
    E(5, 'overland_transshipment', '开展转口贸易陆路走廊运输',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_motorized'),
    E(5, 'direct_distribution', '维护全球零部件直营分销网络',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_phone_call'),
    E(5, 'iso_container_coordination', '与德国协调ISO标准集装箱规格',
      ...
      ('TNO_improve_admin_efficiency_med',), stage=1, icon='GFX_decision_generic_handshake'),
    E(5, 'customs_fast_lane', '与美国建立电子元器件海关快速验放通道',
      ...
      ('TNO_improve_admin_efficiency_high',), stage=2, icon='GFX_decision_generic_checkpoints'),
    E(5, 'south_america_assembly', '在南美洲租赁电子产品加工厂',
      ...
      ('TNO_improve_industrial_equipment_med',), stage=3, icon='GFX_decision_generic_factory_blue'),
...
DECISIONS.extend([
    E(3, 'optical_calibration', '光刻机高频光学校准与维护',
      ...
      ('TNO_improve_research_facilities_low',), icon='GFX_decision_generic_tools'),
    ...
    E(3, 'buy_pellicles', '定期购置防尘薄膜',
      ...
      ('TNO_improve_industrial_equipment_low',), icon='GFX_decision_generic_supply'),
    E(3, 'expert_allowances', '发放光刻专家专项津贴',
      ...
      ('TNO_improve_academic_base_low',), icon='GFX_decision_generic_investors_yen'),
    E(3, 'ccd_scale_up', 'CCD电荷耦合器件研发规模化',
      ...
      icon='GFX_decision_generic_electronics'),
    E(3, 'g_line_stepper', '引进高数值孔径g线步进式光刻机',
      ...
      ('TNO_improve_industrial_expertise_high',), stage=2, icon='GFX_decision_generic_investigate'),
    E(3, 'chrome_quartz_masks', '建设超净铬版石英光罩自主制造线',
      ...
      ('TNO_improve_research_facilities_high',), stage=3, icon='GFX_decision_generic_factory_blue'),
    E(3, 'excimer_alignment', '攻关准分子激光光源与亚微米级对准技术',
      ...
      icon='GFX_decision_generic_atom'),
])
...
DECISIONS.extend([
    E(2, 'replenish_consumables', '补充基础晶圆耗材与化学试剂',
      ...
      ('TNO_improve_industrial_equipment_low',), icon='GFX_decision_generic_research'),
    E(2, 'paramilitary_shifts', '晶圆厂技术员准军事化排班',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_military_parade'),
    E(2, 'spc_control', '导入SPC良率统计控制系统',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_economy_graph'),
    E(2, 'japanese_military_orders', '承接日本军事电子管件代工专单',
      ...
      ('TNO_improve_industrial_equipment_low',), icon='GFX_decision_generic_military_hat'),
    E(2, 'class_1000_cleanroom', '建造千级超净洁净室',
      ...
      ('TNO_improve_research_facilities_med',), stage=1, icon='GFX_decision_generic_building'),
    E(2, 'four_inch_wafer_line', '引入四英寸晶圆标准化生产线',
      ...
      ('TNO_improve_industrial_equipment_high',), stage=2, icon='GFX_decision_generic_factory_blue'),
    E(2, 'implantation_and_oxidation', '攻关高能量离子注入与热氧化扩散',
      ...
      ('TNO_improve_research_facilities_high',), stage=3, icon='GFX_decision_generic_atom'),
...
DECISIONS.extend([
    ...
    E(1, 'smelter_overtime', '推行硅冶炼厂加班班次',
      ...
      ('TNO_improve_industrial_expertise_low',), icon='GFX_decision_generic_clock'),
    E(1, 'power_subsidy', '国家电网特供高耗能电费补贴',
      ...
      ('TNO_improve_industrial_equipment_low',), icon='GFX_decision_generic_power'),
    E(1, 'export_low_grade_products', '对东南亚出口低端硅基产物',
      ...
      ('TNO_improve_admin_efficiency_low',), icon='GFX_decision_generic_supply'),
    E(1, 'polysilicon_plant', '扩建电子级多晶硅提纯厂',
      ...
      ('TNO_improve_industrial_equipment_med',), stage=1, icon='GFX_decision_generic_building'),
    ...
    E(1, 'quartz_monopoly', '垄断高纯度石英矿源',
      ...
      ('TNO_improve_industrial_expertise_med',), stage=3, icon='GFX_decision_generic_diamond'),
...
def render_decision(decision: Decision) -> list[str]:
    if decision.icon not in SAFE_DECISION_ICONS:
        raise ValueError(f'Unverified decision icon: {decision.key}: {decision.icon}')
    icon = decision.icon
    visible = [
    ...
    if decision.group == 1:
        visible.append('DOP_SCW_chain_materials_selected = yes')
    elif decision.group:
        visible.append(
...
def validate_data() -> None:
    ...
    for group in range(6):
        ...
        assert len({item.icon for item in group_decisions}) == 8, GROUP_KEYS[group]
