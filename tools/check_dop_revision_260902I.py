#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902I DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    # Product-cycle and core-stage tooltip copy are author-managed in 260902I.
)
...
def check_events(index: dict[str, tuple[str, object]]) -> None:
    ...
    require(len(rows) == 568, "all 568 mod events are covered by the event audit")
    require(len(unassigned) == 454 and table_rows == 454, "all 454 non-target-focus events have a named table row")
...
def main() -> int:
    ...
    check_content_flow()
    print("DOP 260902I REQUIREMENT ACCEPTANCE: PASS")
    return 0
