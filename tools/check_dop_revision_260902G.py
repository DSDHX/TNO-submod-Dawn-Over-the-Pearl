#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902G DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    # Product-cycle and core-stage tooltip copy are author-managed in 260902G.
)
...
def check_version_and_scope() -> None:
    ...
    require("EARLY DEVELOPMENT BUILD 260902G" in version, "user-facing build is 260902G")
...
def main() -> int:
    ...
    check_content_flow()
    print("DOP 260902G REQUIREMENT ACCEPTANCE: PASS")
    return 0
