#!/usr/bin/env python3
"""Requirement-level static acceptance for the 260902E DOP revision."""
...
TOOLTIP_KEYS = (
    ...
    # Product-cycle and core-stage tooltip copy are author-managed in 260902E.
)
...
def check_version_and_scope() -> None:
    ...
    require("EARLY DEVELOPMENT BUILD 260902E" in version, "user-facing build is 260902E")
    ...
    require(
        ...
        "Long Shengwu character and portrait are wired",
    )
    for token in (
        "recruit_character = DOP_YUN_long_shengwu",
...
def main() -> int:
    ...
    print("DOP 260902E REQUIREMENT ACCEPTANCE: PASS")
    return 0
